...
import { Button } from '@/ui/component/botton'
		...
		<form action={dispatch} className="space-y-3">
			<div className="flex-1 px-6 pt-8 pb-4 rounded-lg bg-gray-50">
				...
				<div className="w-full">
					...
					<div>
						<label
							className="block mt-5 font-medium text-gray-900 text-md"
							htmlFor="name"
						>
							이름
						</label>
						<div className="relative">
							...
							/>
							<UserIcon className="pointer-event-none absolute left-3 top-1/2 h-[18px] w-[18px] -translate-y-1/2 text-gray-500 peer-focus:text-gray-900" />
						</div>
					</div>
					...
					<div>
						...
						<div className="relative">
							...
							/>
							<AtSymbolIcon className="pointer-event-none absolute left-3 top-1/2 h-[18px] w-[18px] -translate-y-1/2 text-gray-500 peer-focus:text-gray-900" />
						</div>
					</div>
					...
					<div className="mt-4">
						...
						<div className="relative">
							...
							/>
							<KeyIcon className="pointer-event-none absolute left-3 top-1/2 h-[18px] w-[18px] -translate-y-1/2 text-gray-500 peer-focus:text-gray-900" />
						</div>
					</div>
